...
<div class="leftnav">
    ...
    <ul style="display: block">
        <li><a href="${ctx}/category/findBySql" target="right"><span class="icon-caret-right"></span>分类管理</a> </li>
        <li><a href="${ctx}/item/findBySql" target="right"><span class="icon-caret-right"></span>书籍管理</a> </li>
...
<ul class="bread">
    <li><a href="${ctx}/item/findBySql" target="right" class="icon-home">首页</a> </li>
    <li><a href="#">当前页面</a> </li>
