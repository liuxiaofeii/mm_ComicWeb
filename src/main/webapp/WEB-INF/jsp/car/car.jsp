...
<div class="width100" style="height: 45px;background: #000000;margin-top: 40px;position: relative;z-index: 100;">
    ...
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh font16" id="pageNav">
            ...
            <a href="${ctx}/news/list">纸质漫画</a>
            <a href="${ctx}/message/add">电子漫画</a>
        </div>
    </div>
</div>
...
<div class="width1198 hidden_yh center_yh" style="border: 1px solid #ddd;margin-top: 18px;min-height: 300px;">
    ...
    <c:forEach items="${list}" var="data" varStatus="l">
        <div class="speCific" data-id="${data.carId}">
            <div class="xzWxz">
                <b><img src="${ctx}/resource/user/images/xzwxz.png"></b>
            </div>
            <div class="xzSp">
                <img src="${localPhot}/${data.book.categoryId}/${data.book.bookId}/420.jpg">
                <div class="xzSpIn">
                    <h3 class="font16 c_33 font100">${data.book.bookName}</h3>
                </div>
            </div>
            <div class="xzJg">
                ￥<font>${data.bookPrice}</font>
            </div>
            <div class="xzSl">
                <div class="xzSlIn">
                    <b class="Amin">减</b>
                    <input type="text" value="${data.purchaseNum}" readonly class="cOnt">
            ...
            <div class="xzSz">
                <div class="xzCzIn">
                    <a href="javascript:void(0)" class="Dels" data-id="${data.carId}">删除</a>
                </div>
            </div>
        </div>
    </c:forEach>
