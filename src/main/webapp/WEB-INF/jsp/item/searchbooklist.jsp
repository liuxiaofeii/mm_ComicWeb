            ...
            <li>
                ...
                <p class="center_yh block_yh hidden_yh" style="width: 202px;">
                    <c:if test="${data.bookFree!=1}">
                        <font class="left_yh red font16">￥${data.bookPrice}</font>
...
<div id="navs">
    <div class="pagelist">
        <!--分页开始-->
        <pg:pager url="${ctx}/item/searchBook" maxIndexPages="5" items="${pagers.total}" maxPageItems="15" export="curPage=pageNumber">
