...
<div class="panel admin-panel">
    ...
    <c:forEach items="${pages.datas}" var="data" varStatus="l">
        <tr>
            ...
            <td>${data.address}</td>
            <td>
                <a class="button border-main" href="${ctx}/user/update?userId=${data.userId}"><span class="icon-edit">修改</span> </a>
                <a class="button border-red" href="${ctx}/user/delete?userId=${data.userId}">
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始-->
                    <pg:pager url="${ctx}/user/findBySql" maxIndexPages="5" items="${pages.total}" maxPageItems="15" export="curPage=pageNumber">
                        <pg:last>
