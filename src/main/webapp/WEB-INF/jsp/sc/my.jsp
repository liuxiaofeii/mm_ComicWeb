...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${ctx}/sc/findBySql" class="on">书籍收藏</a>
                    ...
                    <c:forEach items="${pagers.datas}" var="data" varStatus="l">
                        <a href="${ctx}/item/view?bookId=${data.bookId}">
                            <div class="width100 hidden_yh" style="border-bottom: 1px dashed #ddd;padding-top: 10px;padding-bottom: 10px;">
                                <img src="${localPhot}/${data.book.categoryId}/${data.book.bookId}/420.jpg" width="100" height="100" class="left_yh" style="margin-right: 15px;">
                                <div class="left_yh" style="width: 580px;">
                                    <h3 class="font18 c_33 font100">${data.book.bookName}</h3>
                                    <c:if test="${data.book.bookFree!=1}">
                                    <p class="red" style="margin-top: 10px;">￥${data.book.bookPrice}</p>
                                    </c:if>
                                </div>
                                <div class="right_yh">
                                    <a href="${ctx}/sc/delete?scId=${data.scId}" class="onfff block_yh tcenter font16" style="margin-top: 10px;padding: 6px;">取消收藏</a>
                                </div>
                            </div>
                        </a>
                    </c:forEach>
