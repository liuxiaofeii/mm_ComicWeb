...
<div class="width100" style="height: 25px;background: #f0f0f0;">
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;">
        <font class="left_yh">欢迎来到漫画城</font>
        <a href="${ctx}/login/mLogin" style="color: #666;display: inline-block;margin-left:10px;background-color:#fbeed5">后台管理</a>
...
<div class="width100 hidden_yh">
    <div class="width1200 center_yh hidden_yh">
        ...
        <div class="right_yh" style="height:28px;width:316px;border:2px solid #dd4545;margin-top:-40px;">
            <form action="${ctx}/item/searchBook" method="post">
